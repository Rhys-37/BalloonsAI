...
if __name__ == "__main__":
    ...
    monkey_cards_dir = "./BalloonsAI/Screenshots/MonkeyCards/"

    # Get all files in the MonkeyCards folder
    template_paths = [os.path.join(monkey_cards_dir, f) for f in os.listdir(monkey_cards_dir) if os.path.isfile(os.path.join(monkey_cards_dir, f))]
